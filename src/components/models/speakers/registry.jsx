...
export const MODELS = [
  // LCR — EXACT ORDER
  { key: "q4-3", label: "Q4-3", category: "LCR", widthMm: 280, heightMm: 210, depthMm: 110,
    frontElevationDrawing: {
      version: 1,
      shapes: [
        // Grille inset rectangle
        { type: "rect", x: 0.07, y: 0.07, w: 0.86, h: 0.86, stroke: true, fill: false },
        // Tweeter (top)
        { type: "circle", cx: 0.50, cy: 0.22, r: 0.08, stroke: true, fill: true },
        // Mid driver
        { type: "circle", cx: 0.50, cy: 0.50, r: 0.12, stroke: true, fill: true },
        // Woofer (bottom)
        { type: "circle", cx: 0.50, cy: 0.78, r: 0.15, stroke: true, fill: true },
        // Acoustic centre marker
        { type: "circle", cx: 0.50, cy: 0.50, r: 0.025, stroke: false, fill: false, specialFill: "rgba(255,255,255,0.5)" },
      ]
    }, sensitivity_dB_1w1m: 96, sensitivity_dB_2p83: 99, nominalOhms: 8, max_power: 120, max_spl_cont_db_1m_halfspace: 114, max_spl_peak_db_cf6_1m_halfspace: 120, max_spl_cont_db_1m_anechoic: 108, max_spl_peak_db_cf6_1m_anechoic: 114, price_gbp_exVat: 1820, retailPriceGBP: 1820.00, currency: "GBP", vatIncluded: true, vatRate: 0.20, hfOffAxis16k: { minus3deg: 35, minus5deg: 45 }, dispersion: { horizontal: { minus1p5dB: 38, minus3dB: 54, minus5dB: 72 } } },
