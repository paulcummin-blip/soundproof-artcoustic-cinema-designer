...
export const MODELS = [
  ...
  { key: "evolve-1", label: "EVOLVE 1", category: "LCR", widthMm: 120, heightMm: 120, depthMm: 99, sensitivity_dB_1w1m: 93, sensitivity_dB_2p83: 93, nominalOhms: 8, max_power: 30, max_spl_cont_db_1m_halfspace: 104, max_spl_peak_db_cf6_1m_halfspace: 110, max_spl_cont_db_1m_anechoic: 98, max_spl_peak_db_cf6_1m_anechoic: 104, frequency_response_low: 120, frequency_response_high: 20000, usable_lf_hz_minus6db: 118, coverage_deg: { horizontal: 90, vertical: 90 }, price_gbp_exVat: null },
  { key: "evolve-1-1", label: "EVOLVE 1-1", category: "LCR", widthMm: 120, heightMm: 120, depthMm: 99, sensitivity_dB_1w1m: 93, sensitivity_dB_2p83: 93, nominalOhms: 8, max_power: 30, max_spl_cont_db_1m_halfspace: 104, max_spl_peak_db_cf6_1m_halfspace: 110, max_spl_cont_db_1m_anechoic: 98, max_spl_peak_db_cf6_1m_anechoic: 104, frequency_response_low: 120, frequency_response_high: 20000, usable_lf_hz_minus6db: 118, coverage_deg: { horizontal: 90, vertical: 90 }, price_gbp_exVat: null },
  { key: "sl-evolve-1-1", label: "SL EVOLVE 1-1", category: "LCR", widthMm: 150, heightMm: 150, depthMm: 72, sensitivity_dB_1w1m: 93, sensitivity_dB_2p83: 93, nominalOhms: 8, max_power: 30, max_spl_cont_db_1m_halfspace: 102, max_spl_peak_db_cf6_1m_halfspace: 108, max_spl_cont_db_1m_anechoic: 96, max_spl_peak_db_cf6_1m_anechoic: 102, frequency_response_low: 90, frequency_response_high: 40000, usable_lf_hz_minus6db: 87, coverage_deg: { horizontal: 90, vertical: 90 }, price_gbp_exVat: 400, retailPriceGBP: 400.00, currency: "GBP", vatIncluded: true, vatRate: 0.20 },
  { key: "evolve-2-1", label: "EVOLVE 2-1", category: "LCR", widthMm: 200, heightMm: 200, depthMm: 82, sensitivity_dB_1w1m: 97, sensitivity_dB_2p83: 100, nominalOhms: 4, max_power: 60, max_spl_cont_db_1m_halfspace: 108, max_spl_peak_db_cf6_1m_halfspace: 114, max_spl_cont_db_1m_anechoic: 102, max_spl_peak_db_cf6_1m_anechoic: 108, frequency_response_low: 90, frequency_response_high: 40000, usable_lf_hz_minus6db: 87, coverage_deg: { horizontal: 70, vertical: 90 }, price_gbp_exVat: 780, retailPriceGBP: 780.00, currency: "GBP", vatIncluded: true, vatRate: 0.20, hfOffAxis16k: { minus3deg: 30, minus5deg: 40 }, dispersion: { horizontal: { minus1p5dB: 31, minus3dB: 45, minus5dB: 64 } } },
  { key: "evolve-3-1", label: "EVOLVE 3-1", category: "LCR", widthMm: 270, heightMm: 370, depthMm: 82, sensitivity_dB_1w1m: 97, sensitivity_dB_2p83: 101, nominalOhms: 3, max_power: 90, max_spl_cont_db_1m_halfspace: 110, max_spl_peak_db_cf6_1m_halfspace: 116, max_spl_cont_db_1m_anechoic: 104, max_spl_peak_db_cf6_1m_anechoic: 110, frequency_response_low: 80, frequency_response_high: 40000, usable_lf_hz_minus6db: 77, coverage_deg: { horizontal: 90, vertical: 90 }, price_gbp_exVat: 1170, retailPriceGBP: 1170.00, currency: "GBP", vatIncluded: true, vatRate: 0.20, hfOffAxis16k: { minus3deg: 30, minus5deg: 40 }, dispersion: { horizontal: { minus1p5dB: 39, minus3dB: 55, minus5dB: 73 } } },
  { key: "evolve-4-2", label: "EVOLVE 4-2", category: "LCR", widthMm: 270, heightMm: 370, depthMm: 82, sensitivity_dB_1w1m: 96, sensitivity_dB_2p83: 99, nominalOhms: 4, max_power: 120, max_spl_cont_db_1m_halfspace: 113, max_spl_peak_db_cf6_1m_halfspace: 119, max_spl_cont_db_1m_anechoic: 107, max_spl_peak_db_cf6_1m_anechoic: 113, frequency_response_low: 85, frequency_response_high: 40000, usable_lf_hz_minus6db: 82, coverage_deg: { horizontal: 90, vertical: 58 }, price_gbp_exVat: 1780, retailPriceGBP: 1780.00, currency: "GBP", vatIncluded: true, vatRate: 0.20, hfOffAxis16k: { minus3deg: 30, minus5deg: 40 }, dispersion: { horizontal: { minus1p5dB: 36, minus3dB: 52, minus5dB: 70 } } },
  { key: "evolve-6-3", label: "EVOLVE 6-3", category: "LCR", widthMm: 270, heightMm: 370, depthMm: 82, sensitivity_dB_1w1m: 100, sensitivity_dB_2p83: 103, nominalOhms: 4, max_power: 180, max_spl_cont_db_1m_halfspace: 118, max_spl_peak_db_cf6_1m_halfspace: 124, max_spl_cont_db_1m_anechoic: 112, max_spl_peak_db_cf6_1m_anechoic: 118, frequency_response_low: 90, frequency_response_high: 40000, usable_lf_hz_minus6db: 87, coverage_deg: { horizontal: 90, vertical: 54 }, price_gbp_exVat: 2250, retailPriceGBP: 2250.00, currency: "GBP", vatIncluded: true, vatRate: 0.20, hfOffAxis16k: { minus3deg: 30, minus5deg: 40 }, dispersion: { horizontal: { minus1p5dB: 36, minus3dB: 52, minus5dB: 70 } } },
  ...
  { key: "mikro", label: "MIKRO", category: "SURROUNDS", widthMm: 120, heightMm: 120, depthMm: 80, sensitivity_dB_1w1m: 86, sensitivity_dB_2p83: 86, nominalOhms: 8, max_power: 15, max_spl_cont_db_1m_halfspace: 102, max_spl_peak_db_cf6_1m_halfspace: 108, max_spl_cont_db_1m_anechoic: 96, max_spl_peak_db_cf6_1m_anechoic: 102, frequency_response_low: 300, frequency_response_high: 20000, usable_lf_hz_minus6db: 297, coverage_deg: { horizontal: 90, vertical: 90 }, price_gbp_exVat: null },
  { key: "evolve-1-1_s", label: "EVOLVE 1-1", category: "SURROUNDS", widthMm: 120, heightMm: 120, depthMm: 99, sensitivity_dB_1w1m: 93, sensitivity_dB_2p83: 93, nominalOhms: 8, max_power: 30, max_spl_cont_db_1m_halfspace: 104, max_spl_peak_db_cf6_1m_halfspace: 110, max_spl_cont_db_1m_anechoic: 98, max_spl_peak_db_cf6_1m_anechoic: 104, frequency_response_low: 120, frequency_response_high: 20000, usable_lf_hz_minus6db: 118, coverage_deg: { horizontal: 90, vertical: 90 }, price_gbp_exVat: 550 },
  { key: "sl-evolve-1-1_s", label: "SL EVOLVE 1-1", category: "SURROUNDS", widthMm: 150, heightMm: 150, depthMm: 72, sensitivity_dB_1w1m: 93, sensitivity_dB_2p83: 93, nominalOhms: 8, max_power: 30, max_spl_cont_db_1m_halfspace: 102, max_spl_peak_db_cf6_1m_halfspace: 108, max_spl_cont_db_1m_anechoic: 96, max_spl_peak_db_cf6_1m_anechoic: 102, frequency_response_low: 90, frequency_response_high: 40000, usable_lf_hz_minus6db: 87, coverage_deg: { horizontal: 90, vertical: 90 }, price_gbp_exVat: 400, retailPriceGBP: 400.00, currency: "GBP", vatIncluded: true, vatRate: 0.20 },
  ...
  { 
    ...
    nominalOhms: 8,
    max_power: 15,
    max_spl_cont_db_1m_halfspace: 102,
    max_spl_peak_db_cf6_1m_halfspace: 108,
    max_spl_cont_db_1m_anechoic: 96,
    max_spl_peak_db_cf6_1m_anechoic: 102,
    frequency_response_low: 300,
    frequency_response_high: 20000,
    usable_lf_hz_minus6db: 297,
  ...
  { 
    ...
    nominalOhms: 4, 
    max_power: 60,
    max_spl_cont_db_1m_halfspace: 108,
    max_spl_peak_db_cf6_1m_halfspace: 114,
    max_spl_cont_db_1m_anechoic: 102,
    max_spl_peak_db_cf6_1m_anechoic: 108,
    frequency_response_low: 80,
    frequency_response_high: 40000,
    usable_lf_hz_minus6db: 77,
  ...
  { 
    ...
    bassCapability: SUBWOOFER_BASS_CAPABILITIES["sub2-12"],
    frequency_response_curve: SUBWOOFER_BASS_CAPABILITIES["sub2-12"].frequencyResponseCurve.map(({ frequency, spl }) => [frequency, spl])
  },
  { 
    key: "sub3-12", 
    label: "SUB3-12", 
    ...
    approvedFrequencyRangeHz: [25, 170],
    approvedUsableLfHzMinus6dB: 22,
    bassCapability: SUBWOOFER_BASS_CAPABILITIES["sub3-12"],
    frequency_response_curve: SUBWOOFER_BASS_CAPABILITIES["sub3-12"].frequencyResponseCurve.map(({ frequency, spl }) => [frequency, spl])
  },
  { 
    key: "sub4-12", 
    label: "SUB4-12", 
    ...
    bassCapability: SUBWOOFER_BASS_CAPABILITIES["sub4-12"],
    frequency_response_curve: SUBWOOFER_BASS_CAPABILITIES["sub4-12"].frequencyResponseCurve.map(({ frequency, spl }) => [frequency, spl])
  },
];
...
export function getSpeakerModelMeta(modelName, orientation) {
  ...
  if (hit.round) {
    return {
      ...
      frequency_response_high: hit.frequency_response_high ?? null,
