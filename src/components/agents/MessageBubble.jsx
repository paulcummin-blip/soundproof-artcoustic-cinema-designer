...
export default function MessageBubble({ message }) {
    ...
    return (
        <div className={cn("flex gap-3", isUser ? "justify-end" : "justify-start")}>
            {!isUser && (
                <div className="h-7 w-7 rounded-lg bg-[#213428] flex items-center justify-center mt-0.5">
            ...
            <div className={cn("max-w-[85%]", isUser && "flex flex-col items-end")}>
                {message.content && (
                    <div className={cn(
                        ...
                        isUser ? "bg-[#1B1A1A] text-white" : "bg-white border border-[#DCDBD6]"
                    )}>
                        {isUser ? (
                            ...
                            <ReactMarkdown 
                                ...
                                components={{
                                    ...
                                    a: ({ children, ...props }) => (
                                        <a {...props} target="_blank" rel="noopener noreferrer" className="text-[#213428] hover:underline">{children}</a>
                                    ),
                                    ...
                                    blockquote: ({ children }) => (
                                        <blockquote className="border-l-2 border-[#DCDBD6] pl-3 my-2 text-[#3E4349]">
                                            {children}
                                        </blockquote>
                                    ),
                                }}
