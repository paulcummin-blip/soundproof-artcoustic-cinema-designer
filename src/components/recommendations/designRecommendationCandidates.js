    ...
    if (layout.bed >= 9) {
      ...
      if (removed.length) {
        ...
        pushCandidate(candidates, {
          ...
          description: "Reduces spatial resolution between the front soundstage and surrounds, with less precise localisation and smoother movement across the front sides of the room.",
          seats: safeSeats,
    ...
    if (layout.uppers >= 6) {
      ...
      if (removed.length) {
        ...
        pushCandidate(candidates, {
          ...
          description: "Reduces overhead spatial resolution and front-to-back steering, with less precise localisation above the listening area.",
          seats: safeSeats,
