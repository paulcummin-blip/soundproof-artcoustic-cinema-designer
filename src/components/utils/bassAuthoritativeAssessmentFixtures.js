...
function fixtureCandidate(id, p14, rspPostEqCurve, seatCurve) {
  ...
  return {
    ...
    achievedP19Level: assessment.officialP19.level,
    achievedP19VariationDb: assessment.officialP19.variationDbRaw,
    officialP19VariationDb: assessment.officialP19.variationDbRaw,
    correctableP19VariationDb: assessment.p19.variationDbRaw,
...
export function runBassAuthoritativeAssessmentFixtures() {
  ...
  // Floor-based grading: Math.floor(raw) determines the level.
  // 2.9 → floor=2 → L4, 3.9 → floor=3 → L3, 4.9 → floor=4 → L2, 5.9 → floor=5 → L1.
  check("6a. P19 2.9 dB deviation floors to 2 → L4", Math.abs(belowThreeDbP19.p19.variationDbRaw - 2.9) < 1e-9 && Math.abs(belowThreeDbP19.p19.displayVariationDb - 2.9) < 1e-9 && belowThreeDbP19.p19.level === 4);
  ...
  check("6c. P19 3.9 dB deviation floors to 3 → L3", Math.abs(belowFourDbP19.p19.variationDbRaw - 3.9) < 1e-9 && Math.abs(belowFourDbP19.p19.displayVariationDb - 3.9) < 1e-9 && belowFourDbP19.p19.level === 3);
  ...
  check("6e. P19 4.9 dB deviation floors to 4 → L2", Math.abs(belowFiveDbP19.p19.variationDbRaw - 4.9) < 1e-9 && Math.abs(belowFiveDbP19.p19.displayVariationDb - 4.9) < 1e-9 && belowFiveDbP19.p19.level === 2);
  ...
  check("6g. P19 5.9 dB deviation floors to 5 → L1", Math.abs(belowSixDbP19.p19.variationDbRaw - 5.9) < 1e-9 && Math.abs(belowSixDbP19.p19.displayVariationDb - 5.9) < 1e-9 && belowSixDbP19.p19.level === 1);
  ...
  // Floor-based grading: 4.9 → floor=4 → L2, 5.0 → floor=5 → L1 (P20 caps at L1).
  ...
  check("6k. P20 4.9 dB difference floors to 4 → L2", Math.abs(belowFiveDbDifference.p20.worstSeat.variationDbRaw - 4.9) < 1e-9 && Math.abs(belowFiveDbDifference.p20.worstSeat.displayVariationDb - 4.9) < 1e-9 && belowFiveDbDifference.p20.worstSeat.level === 2);
