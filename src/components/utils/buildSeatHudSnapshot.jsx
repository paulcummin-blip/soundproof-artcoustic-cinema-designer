...
export function buildSeatHudSnapshot({
  ...
  // P17 — engine (computeP17ForAllSeats) is the SOLE P17 authority.
  // No local fallback: an absolute off-axis bucket is a different metric and must
  // not coexist as an alternative scoring authority. When the engine has not
  // published P17, show a neutral unavailable state with no achieved level.
