 ...
 * Group C (±dB variance/deviation, lower is better):  P16, P17, P19, P20 → Math.floor(v*2)/2 (0.5 dB)
 * Group D (bass extension Hz, lower is better):        P18           → Math.floor (1 Hz)
...
export function resolveRp22DesignValue(paramId, rawValue) {
  ...
  if (pid === 16 || pid === 17 || pid === 19 || pid === 20) return Math.floor(rawValue * 2) / 2;

  // Group D — bass extension Hz, lower is better: floor to 1 Hz
