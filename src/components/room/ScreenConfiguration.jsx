...
export default function ScreenConfiguration(props) {
  ...
  return (
    <>
      <div className="space-y-5 font-sans" style={{ fontFamily: 'Didact Gothic, Century Gothic, sans-serif' }}>
        {/* SCREEN SETUP — four compact columns */}
        <div>
          <div style={groupTitleStyle}>Screen Setup</div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            <div>
              <Label className={fieldLabelStyle}>Viewing Width (inches)</Label>
              <Select
                value={(() => {
            ...
            <div>
              <Label className={fieldLabelStyle}>Aspect Ratio</Label>
              <Select
            ...
            <div>
              <Label className={fieldLabelStyle}>Screen Height from Floor (cm)</Label>
              <Input
                type="number"
                step="1"
                min="0"
            ...
            <div>
              <Label className={fieldLabelStyle}>Border Thickness (cm)</Label>
              <Input
                type="number"
                step="0.5"
                min="0"
        ...
        {/* MANUAL OVERRIDE — quiet toggle row */}
        <div>
          <div style={groupTitleStyle}>Manual Override</div>
          <div className="flex items-center justify-between">
            <span className="text-sm font-medium text-[#3E4349]">Manual Screen Size Override</span>
            <Switch
            ...
            <>
              <div className="space-y-3">
                {liveMetrics.rows.map((row) => (
                  <div key={row.rowNumber} className="rounded-md border border-[#ECEAE4] bg-white p-3">
                    <div className="text-[#625143] text-xs font-medium mb-2">Row {row.rowNumber}</div>
                    {row.valid ? (
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                        <div>
                          <div className="text-[#9CA3AF] text-[11px]">Horizontal</div>
                          <div className="text-[#1B1A1A] text-sm font-medium">{row.displayHorizontal}°</div>
                        </div>
                        <div>
                          <div className="text-[#9CA3AF] text-[11px]">Vertical</div>
                          <div className="text-[#1B1A1A] text-sm font-medium">{row.displayVertical}°</div>
                        </div>
                        <div>
                          <div className="text-[#9CA3AF] text-[11px]">Distance</div>
                          <div className="text-[#1B1A1A] text-sm font-medium">{row.viewingDistance.toFixed(2)} m</div>
                        </div>
                        <div>
                      ...
                      <div className="text-amber-600 text-xs">Move this row away from screen to compute angles</div>
                    )}
                  </div>
                ))}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-1">
                  <div>
                    <div className="text-[#9CA3AF] text-[11px]">Viewable area</div>
                    <div className="text-[#1B1A1A] text-sm font-medium">
                      {toCm(viewableDimensions.widthM)} × {toCm(viewableDimensions.heightM)} cm
                    </div>
                  </div>
                  <div>
                    <div className="text-[#9CA3AF] text-[11px]">Overall with border</div>
                    <div className="text-[#1B1A1A] text-sm font-medium">
                      {toCm(overallDimensions.widthM)} × {toCm(overallDimensions.heightM)} cm
                    </div>
                  </div>
                  <div>
                    <div className="text-[#9CA3AF] text-[11px]">Distance from front wall to screen</div>
                    <div className="text-[#1B1A1A] text-sm font-medium">
              ...
              {(() => {
                ...
                return (
                  <div className="space-y-2 mt-3 pt-3 border-t border-[#ECEAE4]">
                    {widthWarning && (
