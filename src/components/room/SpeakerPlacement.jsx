  ...
  useEffect(() => {
    ...
    setSpeakers((prev) => {
      ...
      const updated = list.map((s) => {
        ...
        // --- NEW: median Y between front + side, pinned to side wall X ---
        const medianY = (fy + sy) / 2;

        // Hug to side wall using existing helper (getHuggingCenterLines from outer scope)
        ...
        // Respect corner clearance + room bounds
