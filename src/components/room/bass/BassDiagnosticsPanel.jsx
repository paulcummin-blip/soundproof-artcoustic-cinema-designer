...
export default function BassDiagnosticsPanel({
  ...
  return (
    <>
      ...
      {/* ── Modal Excitation Audit — temporary strict audit ── */}
      <ModalExcitationAudit
        roomDims={roomDims}
        seatingPositions={seatingPositions}
        subsForSimulation={subsForSimulation}
        surfaceAbsorption={surfaceAbsorption}
      ...
      {/* ── Source Excitation Reality Audit — temporary diagnostic ── */}
      <SourceExcitationRealityAudit
        roomDims={roomDims}
        seatingPositions={seatingPositions}
        subsForSimulation={subsForSimulation}
        surfaceAbsorption={surfaceAbsorption}
      ...
      {/* ── Source Curve Root Cause Audit — temporary diagnostic ── */}
      <SourceCurveRootCauseAudit
        roomDims={roomDims}
        seatingPositions={seatingPositions}
        subsForSimulation={subsForSimulation}
        surfaceAbsorption={surfaceAbsorption}
      ...
      {/* ── Reflection/Modal Double-Counting A/B Audit — temporary diagnostic (fixed test case) ── */}
      <ReflectionModalDoubleCountingAudit />

      {/* ── Reflection Vector Phase Trace Audit — temporary diagnostic (fixed test case) ── */}
      <ReflectionVectorPhaseTraceAudit />

      {/* ── Reflection Order Contribution Audit — temporary diagnostic (fixed test case) ── */}
