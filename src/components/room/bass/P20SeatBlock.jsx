 ...
 */
export default function P20SeatBlock({ seatingPositions = [], perSeatP20Results = [], rows: providedRows = null, publicationVerified = true, authorityStatus = null, compact = false }) {
