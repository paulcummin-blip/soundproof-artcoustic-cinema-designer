...
export function runBassResultsPresentationFixtures() {
  ...
  { const f = formatBassResults(ready());   check("4. Ready values format correctly", f.pills.p14.text === "Estimated LFE Capability L1 · 115 dBC — Minimum target" && f.pills.p18.text === "Bass Extension L2 · 23 Hz" && f.pills.p19.text === "Seat Consistency L1 · ±4 dB" && f.pills.p20.text === "Worst Seat Performance L2 · ±3 dB"); }
  ...
  check("7. Multi-seat P20 uses contract authority", formatBassResults(ready()).pills.p20.text === "Worst Seat Performance L2 · ±3 dB");
