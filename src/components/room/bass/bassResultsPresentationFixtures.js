...
import { formatBassResults, engineeringDetailsVisible } from "./bassResultsPresentation.js";
...
export function runBassResultsPresentationFixtures() {
  ...
  { const f = formatBassResults(ready()); check("4. Ready values format correctly", f.pills.p14.text === "P14 L1 · 114.1 dB" && f.pills.p18.text === "P18 L2 · 23.4 Hz" && f.pills.p19.text === "P19 L1 · ±4.7 dB" && f.pills.p20.text === "P20 L2 · ±3.8 dB"); }
  check("5. FAIL retains value", formatBassResults(ready({ level: 0 })).pills.p14.text === "P14 FAIL · 114.1 dB");
  check("6. Single-seat P20 is N/A", formatBassResults(ready({ seats: 1 })).pills.p20.text === "P20 N/A");
  check("7. Multi-seat P20 retains genuine result", formatBassResults(ready()).pills.p20.text === "P20 L2 · ±3.8 dB");
