...
export function runBassResultsPresentationFixtures() {
  ...
  { const f = formatBassResults(ready()); check("4. Ready values format correctly", f.pills.p14.text === "P14 L1 · 115 dB" && f.pills.p18.text === "P18 L2 · 23 Hz" && f.pills.p19.text === "P19 L1 · ±4 dB" && f.pills.p20.text === "P20 L2 · ±3.8 dB"); }
  ...
  check("30. P20 formatting remains unchanged", formatBassParameterValue("p20", 3.8) === "±3.8 dB");
