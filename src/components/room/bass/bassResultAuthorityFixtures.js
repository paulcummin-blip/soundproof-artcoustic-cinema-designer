...
export function runBassResultAuthorityFixtures() {
  ...
  const currentResult = { protocolVersion: BASS_OPTIMISER_PROTOCOL_VERSION, poolVersion: BASS_OPTIMISER_POOL_VERSION, engineVersion: HOUSE_CURVE_ENGINE_VERSION, resultSchemaVersion: BASS_RESULT_SCHEMA_VERSION, metricSchemaVersion: BASS_METRIC_SCHEMA_VERSION, pool };
