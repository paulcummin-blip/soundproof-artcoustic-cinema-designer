...
export default function BestSubLayoutGuide({ roomDims, seatingPositions, rspPosition, sourceHeights, contextId, roomElements, currentSubs, frontSubsCfg, rearSubsCfg, setFrontSubsCfg, setRearSubsCfg, subwooferInstances, setSubwooferInstances }) {
