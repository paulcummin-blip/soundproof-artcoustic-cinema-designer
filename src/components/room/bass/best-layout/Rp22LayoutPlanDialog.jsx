...
export default function Rp22LayoutPlanDialog({ open, onOpenChange, layout, roomDims, onApply, isApplied, applyError }) {
  ...
  return <Dialog open={open} onOpenChange={onOpenChange}>
    <DialogContent className="max-w-xl">
      ...
      <p className="text-[10px] leading-relaxed text-[#8A7B6A]">Predicted from the placement model. Apply this layout to calculate verified RP22 results.</p>
      ...
      <DialogFooter>
        <Button type="button" onClick={() => { onApply(layout); }} className="bg-[#213428] text-white hover:bg-[#3E4349]">
          {isApplied ? "Applied" : "Apply recommended positions"}
        </Button>
      </DialogFooter>
    </DialogContent>
  </Dialog>;
