  ...
  return [
    {
      ...
      icon: "Headphones",
      title: "Listening area coverage",
      paramRef: "RP22 Parameters 1, 4, 6 & 10",
      copy: "The centre seating positions provide balanced coverage from the speaker system with consistent separation from the room boundaries.",
    },
    {
      id: "smooth-three-dimensional-movement",
      category: "Spatial Resolution",
      icon: "ChevronUp",
      title: "Three-dimensional coverage",
      paramRef: "RP22 Parameters 5 & 9",
      copy: "The listener-level and overhead speakers are spaced to provide coverage around and above the seating area.",
    },
    {
      id: "strong-cinema-level-dynamics",
      category: "Dynamic Range",
      icon: "Zap",
      title: "Dynamic range capability",
      paramRef: "RP22 Parameters 12 & 13",
      copy: "The screen, surround and overhead speakers provide dynamic capability at the reference listening position.",
    },
    {
      ...
      copy: "The system maintains a consistent tonal character across the seating area.",
    },
  ];
}