...
appState, // Pass appState directly for setters
{
  ...
  const hydrateFromProject = useCallback((p) => {
    ...
    hydrateProjectIntoAppState(p, appState, {
      ...
      setSeatingRows: appState?.setSeatingRows,
      setSeatsPerRow: appState?.setSeatsPerRow,
      setSeatSpacing: appState?.setSeatSpacing,
      setMlpBasis: appState?.setMlpBasis,
      setSeatingBlockOffset: appState?.setSeatingBlockOffset,
      setRowEarHeights: appState?.setRowEarHeights,
